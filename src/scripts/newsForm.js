...
export const NewsForm = () => {
    ...
    <div class="news-form" style="display: none;">  <!-- added css styling into <div> html to hide forms -->
        ...
        <div class="field"> 
            ...
            <input type="text" id="newsTitle" name="newsTitle" class="input" />
        </div>
        <div class="field">
            <label class="label" for="newsSynopsis">  Synopsis  </label>
            <input type="text" id="newsSynopsis" name="newsSynopsis" class="input" />
        </div>
        <div class="field">
            <label class="label" for="newsURL">  URL  </label>
            <input type="text" id="newsURL" name="newsURL" class="input" />
        </div>
